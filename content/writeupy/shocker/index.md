...
![gobuster finding user.sh under /cgi-bin/](02-gobuster-cgi-bin.png)
...
![Metasploit Shellshock module options](03-shellshock-exploit-options.png)
...
![sudo -l showing the perl rule](04-sudo-l-perl.png)
