...
![nmap scan part 1](01-nmap-1.png)
![nmap scan part 2](02-nmap-2.png)
...
![downloading the PDF from the Public share](04-download-pdf.png)

The PDF documents a temporary MSSQL login left in place for testing:
`PublicUser:GuestUserCantWrite1`.

![credentials found inside the PDF](05-pdf-credentials.png)
...
![adding sequel.htb to /etc/hosts](06-etc-hosts.png)
...
![triggering xp_dirtree against my SMB listener](08-xp-dirtree.png)

Responder caught the `sql_svc` NTLMv2 hash:

![Responder capturing the sql_svc NTLMv2 hash](09-responder-hash.png)
...
![cracking the sql_svc hash](10-hashcat-sqlsvc.png)
...
![netexec confirming WinRM access for sql_svc](11-netexec-sqlsvc.png)
...
![Evil-WinRM shell as sql_svc](12-evilwinrm-sqlsvc.png)
...
![ERRORLOG.BAK leaking ryan.cooper's password](13-errorlog.png)

![ryan.cooper credentials confirmed](14-ryan-creds.png)
...
![netexec confirming WinRM for ryan.cooper](15-netexec-ryan.png)
...
![user flag as ryan.cooper](16-user-flag.png)
...
![certipy-ad find enumerating AD CS](17-certipy-find.png)
...
![template vulnerable to ESC1](19-esc1-template.png)
...
![requesting an Administrator certificate](20-request-cert.png)
...
![certipy authenticating with the certificate for the Administrator hash](21-certipy-auth.png)
...
![Administrator shell](22-admin-shell.png)

Read the root flag from `C:\Users\Administrator\Desktop\root.txt`:

![root flag](23-root-flag.png)
