...
![anonymous FTP login failing](02-ftp-anonymous-denied.png)
...
![the Security Dashboard homepage](03-dashboard.png)
...
![gobuster finding /ip, /netstat, /data, /capture](04-gobuster.png)
...
![downloading another user's capture via the numeric ID](05-idor-download.png)
...
![GTFOBins python entry for the Capabilities abuse](08-gtfobins-python.png)
