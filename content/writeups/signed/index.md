...
![nmap scan — only 1433 open](01-nmap.png)
...
![Responder running](02-responder.png)
![captured NTLMv2 hash](03-captured-hash.png)

Cracked it with hashcat → `mssqlsvc : purPLE9795!@`:

![cracked mssqlsvc password](04-cracked-mssqlsvc.png)
...
![MSSQL login as mssqlsvc](05-mssql-login.png)
...
![not a sysadmin](06-not-sysadmin.png)
...
![password → NT hash](10-nt-hash.png)
...
![ticketer parameter breakdown](11-ticketer-params.png)
...
![authenticated with the ticket](14-use-ticket.png)
![sysadmin confirmed](15-sysadmin.png)
![xp_cmdshell available as sysadmin](16-xp-cmdshell.png)
...
![OPENROWSET file read](18-openrowset.png)
![root flag](19-root-flag.png)
