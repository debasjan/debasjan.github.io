...
![gobuster on port 80](port-80.png)
![the /retro dir](gobuster.png)
...
![WordPress login page](login-web.png)
![wade — this is the author](web-creator.png)
![admin/admin does not work](admin-failed.png)
![wade account confirmed as user](wade-account.png)
...
![the comment leak](comments-file.png)
![the recovered password](password.png)
...
![Burp request for wp-login.php](burp-request.png)
...
![hydra cracking wade](hydra.png)

Confirmed the credential works on the WordPress dashboard:

![WP admin as wade](wordpress.png)
...
![RDP session as wade](rdp-sessie.png)
...
![hhupd.exe running](hhupd.png)
![the vulnerable certificate dialog](certificaat.png)
![choose "Web browser" as the app](chose-web.png)

Internet Explorer opens as SYSTEM. From there I use **File → Save
as** to write a file to disk with an unrestricted picker:

![Save-as under Chrome/IE as SYSTEM](chrome-cvs.png)
![save location in C:\Windows](save-as-cert.png)
