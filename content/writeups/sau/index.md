...
![Request Baskets website](04-request-baskets-web.png)

Checked the version against known CVEs and found **CVE-2023-27163**:

![CVE-2023-27163 detail](02-request-baskets-cve.png)

Created a new basket to start testing:

![creating a new basket](05-creating-basket.png)
...
![listener on port 80](06-listener-80.png)

Set the basket's Forward URL to my own Kali machine:

![setting Forward URL to my Kali IP](07-forward-url-kali.png)
...
![running the Maltrail exploit](11-running-exploit.png)

Got a shell as user `puma`:

![shell landing as puma](12-shell-puma.png)
...
![sudo -l showing the systemctl status rule](03-sudo-systemctl.png)
...
![CVE-2023-26604 detail](14-cve-2023-26604.png)
...
![root shell via the pager escape](15-root-shell.png)
