...
![HFS panel showing version 2.3](02-hfs-version-panel.png)
...
![Metasploit finding the rejetto_hfs_exec module](03-msf-search-hfs.png)
...
![WinPEAS finding AutoLogon credentials](05-winpeas-autologon-creds.png)

Second: a known-vulnerable, **unpatched Windows kernel version** flagged
directly against exploit-suggester references:

![WinPEAS flagging the vulnerable kernel build](06-winpeas-vulnerable-kernel.png)
...
![nt authority\system confirmed](07-system-shell.png)
