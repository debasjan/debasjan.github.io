...
![Metasploit brute-forcing the Tomcat manager login](02-tomcat-mgr-login-bruteforce.png)
...
![deploying the malicious WAR through the manager interface](03-war-shell-deploy.png)
