...
![Nikto confirming authenticated Tomcat manager access](02-nikto-tomcat-auth.png)
...
**See also:** [Web application attacks methodology](https://github.com/debasjan/security-portfolio/blob/main/methodology/web-application-attacks.md)
