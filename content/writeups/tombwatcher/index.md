...
categories: ["writeups"]
summary: "TombWatcher is a hard-flavoured Medium AD box that chains six ACL primitives end-to-end: targeted Kerberoast (WriteSPN), AddSelf into a group that can read a gMSA password, gMSA-driven password reset, WriteOwner + GenericAll on a Domain Admin, and finally a dacledit-driven GenericAll on the ADCS OU that unlocks an ESC3 template for Domain Admin certificates. Every step is one bloodyAD or Certipy call."
ShowToc: true
TocOpen: false
cover:
  image: "00-card.png"
...
![RDP session as john](18-rdp-john.png)
...
![certipy finds a vulnerable ESC3 template](21-certipy-find.png)
...
![the User template — ESC3 target](22-user-template-esc3.png)
...
![certipy requests + saves administrator.pfx](23-certipy-request-cert.png)
...
![certipy auth — Administrator NT hash returned](24-certipy-auth.png)
