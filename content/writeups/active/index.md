...
![anonymous SMB login and pulling files recursively](05-anonymous-smb-login.png)

Pulling everything down recursively, one file immediately stood out among
the Group Policy files:

![listing turned up Groups.xml under Preferences\Groups](06-groups-xml-listing.png)
...
![Groups.xml containing a GPP cpassword entry](02-groups-xml-cleartext-cred.png)
...
![decrypting the cpassword with gpp-decrypt](07-gpp-decrypt.png)
...
![hashcat cracking the Administrator TGS hash](09-hashcat-cracked-admin.png)
...
![psexec landing a SYSTEM shell](11-psexec-system-shell.png)
