...
![BloodHound collection](02-bloodhound-collect.png)

Levi is a member of `HR`, which has `GenericWrite` over the `Developers`
group:

![GenericWrite over Developers](03-genericwrite-developers.png)

`GenericWrite` on a group means I can modify its membership and add myself:

![abuse info for the edge](04-abuse-info.png)
...
![snap John supports KeePass 4](10-snap-john.png)
...
![ant.edwards valid](15-spray-ant.png)
![DEV share read/write as ant.edwards](16-dev-rw.png)
...
![GenericAll over adam.silver](17-genericall-adam.png)
...
![re-enabling the account](20-enable-account.png)

Adam now authenticates and has WinRM access:

![adam.silver over WinRM](21-adam-winrm.png)

```bash
evil-winrm -i 10.129.232.75 -u adam.silver -p newP@ssword2026
```

![user flag](22-user-flag.png)
...
![backup ZIP in C:\Backups](23-backup-zip.png)
...
![DPAPI blobs and master key](27-dpapi-files.png)
...
![SMB server on Kali](28-smbserver.png)
![exfiltrating the DPAPI files](29-exfil-dpapi.png)
...
![Administrator shell](31-admin-shell.png)

Read the final flag from `C:\Users\Administrator\Desktop\root.txt`:

![root flag](32-root-flag.png)
