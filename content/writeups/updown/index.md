...
![git-dumper pulling the exposed .git repository](02-git-dumper.png)
...
![Burp match-and-replace rule adding the Special-Dev header](03-burp-special-dev-header.png)
...
![dfunc-bypasser flagging proc_open as enabled](04-dfunc-bypasser-proc-open.png)
