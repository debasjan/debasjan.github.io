...
![nmap script scan](02-nmap-scripts.png)
...
![cleaned users.txt](05-user-list-cleaned.png)
...
![GetNPUsers walking the user list](06-getnpusers.png)

One user — **`support`** — coughs up a hash:

![AS-REP hash for support](07-asrep-hash-support.png)
...
![hashcat cracks support](08-hashcat-crack.png)
...
![valid creds for support](09-support-valid.png)
...
![bloodhound collection](10-bloodhound-collect.png)
...
![ForceChangePassword edge to audit2020](11-bloodhound-forcechangepassword.png)
...
![new share visible: forensic](14-forensic-share.png)
![forensic/memory_analysis contents](15-forensic-listing.png)
...
![downloading the dumps](16-download-zips.png)
![lsass.zip in hand](17-lsass-zip.png)

```bash
7z x lsass.zip
```

![unzipped lsass.DMP](18-lsass-unzipped.png)
...
![installing pypykatz](19-pypykatz-install.png)
![pypykatz output — svc_backup NT hash](20-pypykatz-svc-backup.png)
...
![evil-winrm as svc_backup](22-evilwinrm-svc-backup.png)
![user.txt](23-user-flag.png)
...
![reg save hives](25-shell.png)
![smbserver.py hosting my share](26-smbserver-host.png)
![hives saved on the DC](27-reg-save-sam-system.png)
![copying to my SMB server](28-copy-sam-system.png)
...
![backup_operator dumping the hives](29-nxc-backup-operator.png)
...
![domain Administrator cleartext credential](30-nxc-admin-cleartext.png)
![domain Administrator NT hash](31-administrator-nt-hash.png)
...
![DSRM local hash vs domain Administrator hash side by side](32-dsrm-vs-domain-hash.png)
...
![evil-winrm as Administrator](33-evilwinrm-admin.png)
![root.txt](34-root-flag.png)
...
**See also:** [Active Directory methodology](https://github.com/debasjan/security-portfolio/blob/main/methodology/active-directory.md)
