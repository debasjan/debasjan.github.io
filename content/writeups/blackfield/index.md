...
![hashcat cracks support → #00^BlackKnight](08-hashcat-crack.png)
...
- **`Administrator@BLACKFIELD`** — a real Domain Admin session that
  ...
  ![Domain Administrator NT hash from pypykatz](31-administrator-nt-hash.png)

- **`DC01$`** machine account hash (interesting for silver tickets /
  RBCD, not needed here):

  ![DC01$ machine account hash](32-dsrm-vs-domain-hash.png)
...
![evil-winrm shell as svc_backup](25-shell.png)
...
![impacket-smbserver serving my working dir](26-smbserver-host.png)
...
![reg save sam + system on the DC](27-reg-save-sam-system.png)
...
![hives copied to my SMB server](28-copy-sam-system.png)
...
![backup_operator dumping SAM + SYSTEM + SECURITY](29-nxc-backup-operator.png)
