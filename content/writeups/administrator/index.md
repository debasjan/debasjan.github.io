...
date: 2026-02-03
draft: false
tags: ["hackthebox", "windows", "active-directory", "medium", "acl-abuse", "bloodhound", "dcsync", "password-cracking"]
categories: ["writeups"]
...
![BloodHound collection running](03-bloodhound-collection.png)
...
![BloodHound's abuse info for the edge](05-forcechangepassword-info.png)
...
![resetting Michael's password](06-net-rpc-password-michael.png)

Checked FTP access with the new account, but got denied:

![FTP access denied for michael](07-ftp-denied-michael.png)
...
![evil-winrm shell as michael](08-evilwinrm-michael.png)
...
![BloodHound showing Michael's ForceChangePassword over Benjamin](09-bloodhound-michael-benjamin.png)
...
![bloodyAD resetting Benjamin's password](10-bloodyad-benjamin.png)

Saw that Benjamin is a member of the **Share Moderators** group, meaning
he could have access to the FTP service:

![Benjamin's group membership including Share Moderators](11-benjamin-share-moderators.png)
...
![downloading Backup.psafe3 over FTP as benjamin](12-ftp-download-psafe3.png)
...
![looking up the hashcat mode for Password Safe v3](13-hashcat-mode-lookup.png)

```bash
hashcat -m 5200 Backup.psafe3 /usr/share/wordlists/rockyou.txt
```

![cracking the Password Safe master password](14-hashcat-cracking-psafe3.png)

Installed `pwsafe` to open the database with the cracked password,
`tekieromucho`:

![opening the database in Password Safe](15-pwsafe-open.png)

Copied out the stored users and their passwords:

![Password Safe entries: alexander, emily, emma](16-pwsafe-entries.png)
...
![crackmapexec spraying the recovered passwords](17-crackmapexec-spray.png)
...
![running targetedKerberoast against ethan](19-targetedkerberoast.png)
...
![cracking ethan's Kerberoast hash](20-hashcat-cracking-ethan.png)

![hashcat result: ethan's password recovered](21-ethan-cracked.png)
...
![secretsdump dumping every domain hash](22-secretsdump-hashes.png)
