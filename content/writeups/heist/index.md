...
![type-7 decode](04-type7-decode.png)
![type-5 crack](05-type5-crack.png)
![recovered password 1](06-password-1.png)
![recovered password 2](07-password-2.png)
...
![SMB RID brute enumerating users](08-rid-brute.png)
...
![password spray hitting the Chase account](09-spray-chase.png)
...
![WinRM shell as chase](10-winrm-chase.png)
![user flag](11-user-flag.png)
...
![winPEAS upload](12-winpeas-upload.png)
...
![Firefox running](15-firefox-running.png)
...
![Administrator password recovered from the dump](18-admin-password.png)
...
![SYSTEM shell](19-system-shell.png)

`NT AUTHORITY\SYSTEM`. Read the root flag:

![root flag](20-root-flag.png)
