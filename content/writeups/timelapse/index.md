...
date: 2026-05-17
draft: false
tags: ["hackthebox", "windows", "active-directory", "easy", "password-cracking", "adcs", "certificate-auth", "laps"]
categories: ["writeups"]
...
![SMB share listing and pulling winrm_backup.zip](02-smb-winrm-backup.png)
...
![authenticating to WinRM with the cert/key pair](04-cert-key-winrm-login.png)
...
![PowerShell history containing a PSCredential for svc_deploy](05-powershell-history-creds.png)
...
![svc_deploy's group memberships including LAPS_Readers](06-svc-deploy-whoami-priv.png)
...
![retrieving the DC's LAPS password](03-laps-admin-credential.png)
