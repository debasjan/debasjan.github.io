...
![anonymous RPC bind enumerating usernames](02-rpc-user-enum.png)
...
![lockoutThreshold coming back as 0](06-lockout-policy-check.png)
...
![PowerShell transcript leaking a credential on the command line](03-ps-transcript-leak.png)
...
![ryan's membership in the DnsAdmins group](04-dnsadmins-group.png)
...
![hosting the malicious DLL over an Impacket SMB server](08-msfvenom-dll-smbserver.png)
